...
<tr>
                      ...
                      <td><img style="width: 118px;" src="../assets/images/background/<?php echo $result['man']; ?>"></td>
                      <td><img style="width: 118px;" src="../assets/images/background/<?php echo $result['img']; ?>"></td>
                      <td>
                      	<a href="edittestinfo.php?id=<?php echo $result['id']; ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light m-1"> <i class="fa fa-cog"></i></button></a></td>
<?php } } ?>
                    </tr>
                  </tbody>
                </table>
