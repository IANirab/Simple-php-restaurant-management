...
<h3 align="center">Edit Phone Number</h3>
<hr>

<label for="basic-textarea">Phone Number</label>
<textarea rows="4" name="body" class="form-control" id="basic-textarea"><?php echo $result['number']; ?></textarea><br>
