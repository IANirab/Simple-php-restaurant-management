  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!--Start Dashboard Content-->
                    ...
                    if (isset($_GET['id'])) {
                    $id=$_GET['id'];
                    $delquery = "delete from tbl_mail where id='$id'";
...
<div class="card">
            <div class="card-body">
              <h5 class="card-title"><h4 class="text-info">All Contact Emails</h4><br><a href="addmail.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
