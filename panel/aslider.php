  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!--Start Dashboard Content-->
                    ...
                    if (isset($_GET['did'])) {
                    $id=$_GET['did'];
                    $delquery = "delete from tbl_about1 where id='$id'";
...
<div class="card">
            <div class="card-body">
              <h5 class="card-title"><h4 class="text-info">All slider for About Page </h4><br><a href="addslider.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
        <div class="">
                <table class="table">
...
<tr>
                      <th><img style="width: 118px;" src="../assets/images/timeline/<?php echo $result['img']; ?>"></th>
                      <td><?php echo $result['title']; ?></td>
                      <td><?php echo $result['year']; ?></td>
                      <td><?php echo $fm->textshorten($result['body']); ?></td>
                      <td><a href="eslider.php?id=<?php echo $result['id']; ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light m-1"> <i aria-hidden="true" class="fa fa-cog"></i> </button></a>
