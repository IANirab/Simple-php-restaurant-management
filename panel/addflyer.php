  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        move_uploaded_file($file_temp, $upload_img);
            ...
            if (empty($file_name) || empty($body) || empty($body2)) {
                echo "
            ...
            if($file_name =='' || $body =='' || $body2 ==''){
                $error = "Field Must not Be Empty";
            }else{
                $query = "INSERT INTO tbl_banner(title,body,img) VALUES('$body','$body2','$unique_img')";
...
<h3 align="center">Add Banner For Home Page</h3>
<hr>
...
<label for="basic-textarea">Short Details</label>
