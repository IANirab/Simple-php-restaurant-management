...
<div style="padding: 15px;" class="alert alert-primary" role="alert">
 All Message's is set for Users<br>
</div>
...
?>
    <tr>
      ...
      <td><a href="editmail.php?id=<?php echo $result['id']; ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light m-1"> <i aria-hidden="true" class="fa fa-cog"></i> </button></a></td>
    </tr>
<?php } } ?>
  </tbody>
</table>
