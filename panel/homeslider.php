...
<div class="card">
            <div class="card-body">
              <h5 class="card-title"><h4 class="text-info">All Slide Homepage </h4><br><a href="addhomeslider.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
...
?>
                    ...
                    <tr>
                      <td><img style="width:150px;" src="../assets/images/slider/<?php echo $result['img']; ?>" /></td>
