...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $upload_img = "../assets/images/timeline/".$unique_img;
...
<?php
$id = $_GET['id'];
$query = "select * from tbl_about1 where id='$id'";
$post = $db->select($query);
if($post){   
   while($result = $post->fetch_assoc()){
?>
<form action="" method="post" enctype="multipart/form-data">
<h3 align="center">Edit Slider</h3>
<hr>
...
<textarea rows="4" name="title" class="form-control" id="basic-textarea"><?php echo $result['title']; ?></textarea><br>

<label for="basic-textarea">Year</label>
<textarea rows="4" name="year" class="form-control" id="basic-textarea"><?php echo $result['year']; ?></textarea><br>
<br>
