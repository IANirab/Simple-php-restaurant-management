...
<h5 class="card-title"><h4 class="text-info">Display Service in Homepage </h4><br><a href="addservice.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
...
?>
                    ...
                    <tr>
                      ...
                      <td><a href="editservice.php?id=<?php echo $result['id']; ?>">
