  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!--Start Dashboard Content-->
                    ...
                    if (isset($_GET['did'])) {
                    $id=$_GET['did'];
                    $delquery = "delete from tbl_footer where id='$id'";
...
<div class="card">
            <div class="card-body">
              <h5 class="card-title"><h4 class="text-info">All Footer Menu </h4><br><a href="addfmenu.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
...
?>
                    ...
                    <tr>
                      ...
                      <td>
                      	<a href="editfmenu.php?id=<?php echo $result['id']; ?>">
