        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          <div class='alert alert-danger alert-dismissible' role='alert'>
           ...
           <i class='icon-check'></i>
            ...
            $body1  =  mysqli_real_escape_string($db->link,$_POST['cat']);
            
            
            if($body1 ==''){
                $error = "Field Must not Be Empty";
            }else{
                $query = "INSERT INTO tbl_category(name) VALUES('$body1')";
...
<form action="addblogcat.php" method="post">
<label for="basic-input">Creat Category</label>
<input type="text" name="cat" id="basic-input" class="form-control">
<br>
