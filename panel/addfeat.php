        ...
        move_uploaded_file($file_temp, $upload_img);
           ...
           <i class='icon-check'></i>
            ...
            if($file_name =='' || $title =='' || $year =='' || $body ==''){
                ...
                $query = "INSERT INTO tbl_feature(title,body,link,img) VALUES('$title','$year','$body','$unique_img')";
...
<form action="addfeat.php" method="post" enctype="multipart/form-data">
...
<textarea rows="4" placeholder="Don't Use 'http://' " name="body" class="form-control" id="basic-textarea"></textarea><br>
<br>
