...
<tr>
                      <td><?php echo $result['dishes']; ?></td>
                      <td><?php echo $result['customers']; ?></td>
                      <td><?php echo $result['awards']; ?></td>
                      <td><?php echo $result['working_hours']; ?></td>
                      <td>
                        <a href="editcounter.php?id=<?php echo $result['id']; ?>">
