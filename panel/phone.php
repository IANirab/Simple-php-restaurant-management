  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!--Start Dashboard Content-->
                    ...
                    if (isset($_GET['did'])) {
                    $id=$_GET['did'];
                    $delquery = "delete from tbl_phone where id='$id'";
...
<div class="card">
            <div class="card-body">
              <h5 class="card-title"><h4 class="text-info">All Contact Phone Number </h4><br><a href="addphone.php"><button type="button" class="btn btn-square btn-outline-success waves-effect waves-light m-1">Add New</button></a><br><br></h5>
...
?>
                    ...
                    <tr>
                      ...
                      <td>
                      	<a href="editphone.php?id=<?php echo $result['id']; ?>">
